...
part of 'model_contacts.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ModelContactsAdapter extends TypeAdapter<ModelContacts> {
  @override
  final int typeId = 0;

  @override
  ModelContacts read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, ModelContacts obj) {
    writer
      ..writeByte(8)
      ..writeByte(0)
      ..write(obj.id)
